...
/**
 * @Title:  com.swufe.javaee.myservlet.Server.java
 * @Description: 打开服务
 */
public class Server implements Runnable {
    ...
    public void run() {
        try {
            ...
            String path = this.getClass().getClassLoader().getResource("server.xml").getPath();
            String portStr = XMLUtil.getRootElement(path).element("port").getText();
